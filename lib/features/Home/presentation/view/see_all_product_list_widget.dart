...
class SeeAllProductListWidget extends StatefulWidget {
  const SeeAllProductListWidget({super.key, required this.items, this.title});

  final List items;
  final String? title;

  @override
  State<SeeAllProductListWidget> createState() =>
      _SeeAllProductListWidgetState();
}

class _SeeAllProductListWidgetState extends State<SeeAllProductListWidget> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // StreamBuilder<CommonProductModel>(
          //   stream: subCategoryItemRxObj.dataFetcher,
