...
const String kKeyCartItems = 'cart_items';
const String kKeyWishlistitems = 'wishlist_items';
const String kKeyLoginitems = 'login_items';
//order statuses
...
const Map appLanguages = <String, String>{
  kKeyEnglish: "English",
  kKeyBangla: 'বাংলা',
